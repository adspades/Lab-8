...
game_over = pg.image.load(r"C:\Users\PC\Desktop\Python\lab1\LAB8\racer\images\gameover.jpg")
bg = pg.image.load(r"C:\Users\PC\Desktop\Python\lab1\LAB8\racer\images\AnimatedStreet.png")
...
class Enemy(pg.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pg.image.load(r"C:\Users\PC\Desktop\Python\lab1\LAB8\racer\images\Enemy.png") # load image
...
class Player(pg.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pg.image.load(r"C:\Users\PC\Desktop\Python\lab1\LAB8\racer\images\Player.png") # load image
        self.rect = self.image.get_rect()
...
class Coin(pg.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pg.image.load(r"C:\Users\PC\Desktop\Python\lab1\LAB8\racer\images\coin.png") # load image
        self.rect = self.image.get_rect()
